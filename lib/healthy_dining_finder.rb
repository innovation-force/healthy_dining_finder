module HDF
 ...
 require 'logger'
  ...
  def client_dishes_all_details(client_code)
  ...
  def client_dishes_all_details_by_radius(address, radius)
  ...
  def restaurants_by_location(address)
      address_encoded = URI.encode(address)
  ...
  def dishes_by_sodium(address, keyword, sodium, radius)
      address_encoded = URI.encode(address)
